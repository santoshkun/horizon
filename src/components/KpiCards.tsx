  ...
  return (
    <div className="kpi-row">
      <div className="kpi-card">
        <div className="kpi-label">Positive {horizonLabel} periods</div>
      ...
      <div className="kpi-card">
        <div className="kpi-label">Typical rolling return</div>
      ...
      <div className="kpi-card">
        <div className="kpi-label">Average drawdown</div>
      ...
      <div className="kpi-card">
        <div className="kpi-label">Deepest drawdown</div>
      ...
      <div className="kpi-card">
        <div className="kpi-label">Best rolling return</div>
